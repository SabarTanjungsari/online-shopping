    ...
    <div class="row">
                ...
                <c:forEach items="${checkoutModel.cartLines}" var="cartLine">
                    <div class="col-xs-12">
                        ...
                        <div>
                            ...
                            <h5>Buying Price - &#x52;&#x70; ${cartLine.buyingPrice}/-</h5>							
                        </div>						
                        <hr/>
                        <div class="text-right">
                            <h3>Grand Total -&#x52;&#x70; ${cartLine.total}/-</h3>
                        </div>						
                    </div>
                </c:forEach>
            </div>
        ...
        <div class="col-md-6">
            ...
            <ul class="nav nav-pills nav-stacked">
                <li class="active"><a href="#"><span class="badge pull-right"> &#x52;&#x70; ${checkoutModel.checkoutTotal}/-</span> Final Payment</a></li>
            </ul>
            <br/>
