...
//console.log('Inside the table!');
        ...
        if (window.categoryId == '') {
            ...
            jsonUrl = contextRoot + '/json/data/category/' + window.categoryId + '/products';
        }
...
// dismissing the allert after 3 second
    var $alert = $('.alert');
    if ($alert.length) {
        setTimeout(function () {
            $alert.fadeOut('slow');
            ...
            columns: [
                ...
                },
                {
                    ...
                    mRender: function (data, type, row) {
                        ...
                        // str += '<a href="' + window.contextRoot + '/manage/' + data + '/product"><button onclick="editProduct()">test</button></a>'
                        str += '<button type="button" class="btn btn-warning" onclick="editProduct(' + data + ')">';
                        str += '<span class="glyphicon glyphicon-pencil"></button>';
        ...
        $categoryForm.validate({
            ...
            messages: {
                name: {
                    ...
                    minlength: 'The category name be should not be less than 2 characters'
                },
                description: {
    ...
    // --------------------------------------------
    // handle the click event of refresh cart button
